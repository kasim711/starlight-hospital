        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white text-sm"
            />
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {loading ? (
          ...
          <div className="bg-white p-12 rounded-3xl border border-slate-200 text-center space-y-3">
            ...
            <h3 className="text-xl font-bold text-navy-500">No articles found</h3>
          ...
          <div className="space-y-12">
            ...
            {featuredArticle && !selectedCategory && !searchQuery && (
              <div className="bg-white rounded-3xl border border-slate-200 shadow-card overflow-hidden grid grid-cols-1 lg:grid-cols-12 group">
                ...
                <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between space-y-6">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-navy-500 group-hover:text-teal-600 transition-colors">
                  ...
                  <div>
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-teal-500 text-white font-bold text-sm hover:bg-teal-600 transition-colors shadow-md"
                    >
                ...
                >
                  <div>
                    <div className="relative h-48 overflow-hidden">
                      <img
                        ...
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                      />
                      <span className="absolute top-3 left-3 bg-navy-500/90 text-white text-xs font-semibold px-2.5 py-1 rounded-md backdrop-blur-md">
                        {art.category}
                      </span>
                    </div>
                    <div className="p-6 space-y-3">
                      <div className="flex items-center gap-3 text-xs text-slate-500 font-medium">
                        <span className="flex items-center gap-1"><Clock className="w-3.5 h-3.5 text-teal-500" /> {art.reading_time} min</span>
                        <span>•</span>
                        <span>{art.author}</span>
                      </div>
                      <h3 className="text-xl font-bold text-navy-500 group-hover:text-teal-600 transition-colors line-clamp-2">
                  ...
                  <div className="p-6 pt-0 mt-4 border-t border-slate-100">
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 text-teal-600 font-bold text-sm hover:text-navy-500 transition-colors"
                    >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-100 border border-slate-200 rounded-2xl p-6 flex items-start gap-4 text-slate-700">
          ...
          <div className="space-y-1 text-xs sm:text-sm">
            <span className="font-bold text-navy-500 block">General Educational Notice</span>
