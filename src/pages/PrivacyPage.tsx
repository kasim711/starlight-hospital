  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 space-y-8 font-sans">
      <div className="space-y-3">
        <span className="badge-teal">LEGAL DISCLOSURE</span>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-navy-500 flex items-center gap-3 tracking-tight">
          <ShieldCheck className="w-8 h-8 text-teal-600" /> Privacy Policy
        </h1>
        <p className="text-slate-500 text-xs font-semibold">Last updated: August 2026 • Starlight Hospital</p>
      </div>

      <div className="healthcare-card p-8 sm:p-10 space-y-6 text-slate-700 leading-relaxed text-sm sm:text-base font-normal">
        
        <section className="space-y-3">
          <h2 className="text-xl font-extrabold text-navy-500 tracking-tight">1. Information We Collect</h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-slate-100">
          <h2 className="text-xl font-extrabold text-navy-500 tracking-tight">2. Why Information Is Collected</h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-slate-100">
          <h2 className="text-xl font-extrabold text-navy-500 tracking-tight">3. Data Access & Protection</h2>
          <p>
        ...
        <section className="space-y-3 pt-6 border-t border-slate-100">
          <h2 className="text-xl font-extrabold text-navy-500 tracking-tight">4. Contacting Us Regarding Your Data</h2>
          <p>
          ...
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200/80 text-xs sm:text-sm font-semibold space-y-1 text-slate-800">
            <div><strong className="text-navy-500">Starlight Hospital</strong></div>
